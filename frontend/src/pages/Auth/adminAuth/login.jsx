  ...
  return (
    <div className="p-5">
      <form onSubmit={handleLogin}>
        <h1 className="text-2xl text-center font-bold cursor-default" onClick={() => navigate("/")}>Login Admin</h1>
        <AuthInput
          value={email}
        ...
        <p className="text-[16px] text-slate-800 mt-3">
          ...
          <Link className="font-medium text-primary underline" to="/register/admin">
            Register
          </Link>
        </p>
      </form>
